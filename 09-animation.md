...
`Rig` - это система управления моделью

Минимальный риг может состоять только из обычных костей. Более сложный риг может включать:
...
![Rig Example](assets/09_rig_example.png)
